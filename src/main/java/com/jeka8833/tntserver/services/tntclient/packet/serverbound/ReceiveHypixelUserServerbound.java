...
public final class ReceiveHypixelUserServerbound implements ServerBoundPacket {
    private final @NotNull Map<@NotNull UUID, @NotNull HypixelCompactStructure> players;
    private final boolean lastPacket;

    public ReceiveHypixelUserServerbound(@NotNull Map<@NotNull UUID, @NotNull HypixelCompactStructure> players,
                                         boolean lastPacket) {
        this.players = players;
        this.lastPacket = lastPacket;
    }

    public ReceiveHypixelUserServerbound(@NotNull InputByteArray serializer, Integer protocolVersion) {
    ...
    private static void writeUser(@NotNull OutputByteArray serializer, int protocolVersion,
        ...
        serializer.writeInt(7);     // new_tntrun_double_jumps

        serializer.writeInt(structure.pvpRunWins());
        serializer.writeInt(structure.pvpRunLosses());
        serializer.writeInt(7);     // new_pvprun_double_jumps
        ...
        serializer.writeInt(7);     // new_spleef_double_jumps
