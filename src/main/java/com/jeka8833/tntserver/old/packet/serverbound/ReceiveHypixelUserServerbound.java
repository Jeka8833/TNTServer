...
public record ReceiveHypixelUserServerbound(@NotNull Map<@NotNull UUID, @NotNull HypixelCompactStructure> players,
                                            boolean lastPacket) implements PacketBase {
    public ReceiveHypixelUserServerbound(@NotNull PacketInputSerializer serializer, int protocolVersion) {
