...
public class RequestHypixelUserServerbound implements ServerBoundPacket {
    private final @NotNull Set<@NotNull UUID> players;

    public RequestHypixelUserServerbound(@NotNull Set<@NotNull UUID> players) {
        this.players = players;
    }

    public RequestHypixelUserServerbound(@NotNull InputByteArray serializer, Integer protocolVersion) {
