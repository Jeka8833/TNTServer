...
public final class ServerPacketRegistry<Key, ClientboundType extends PacketBase<Attachment>,
    ...
    private final Map<Key, BiFunction<InputByteArray, Attachment, ServerboundType>> registrations;
    ...
    ServerPacketRegistry(Map<Key, ConnectionBuilder<Key, ClientboundType, ServerboundType, Attachment>> map) {
        Map<Key, BiFunction<InputByteArray, Attachment, ServerboundType>> registrationsTemp =
    ...
    public ServerboundType createServerBoundPacket(
        ...
        BiFunction<InputByteArray, Attachment, ServerboundType> registration = registrations.get(identifier);
